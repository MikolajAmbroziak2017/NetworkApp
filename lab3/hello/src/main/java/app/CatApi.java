...
public class CatApi {
    ...
    public ResponseEntity<CatResource>  getCatById (@PathVariable("cat_id") Integer id) {
...
//           return  null;
        ...
        return ResponseEntity.ok().body(new CatResource(resultCat,id));
        //return petmenager.getCatById(id);
    }
